					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="social-sits">
											&lt;!&ndash;<div class="facebook-button">
												<a href="#">微信登录</a>
											</div>
										...
										<!--<div class="signup">
											<form>
												<input type="text" class="email" placeholder="手机号/邮箱" maxlength="10" pattern="[1-9]{1}\d{9}" title="Enter a valid mobile number" />
											</form>
									...
									<!--<div id="small-dialog3" class="mfp-hide">
										...
										<div class="social-sits">
											...
											<div class="button-bottom">
												<p>已有账户去<a href="#small-dialog" class="play-icon popup-with-zoom-anim">登录</a></p>
											</div>
										</div>
										<div class="signup">
											<form>
												<input type="text" class="email" placeholder="邮箱/手机号" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email"/>
				...
				<div class="signin">
					...
					<!--<div id="small-dialog" class="mfp-hide">
						...
						<div class="social-sits">
							...
							<div class="button-bottom">
								<p>没有账户，请点击 <a href="#small-dialog3" class="play-icon popup-with-zoom-anim">注册</a></p>
							</div>
						</div>
						<div class="signup">
							<form>
								<input type="text" class="email" placeholder="手机号/邮箱" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
								<input type="password" placeholder="密码" required="required" pattern=".{6,}" title="Minimum 6 characters required" autocomplete="off" />
								<input type="submit"  value="登录"/>
							</form>
							<div class="forgot">
