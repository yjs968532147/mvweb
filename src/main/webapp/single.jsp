    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../resources/templates/index.jsp"><h1><img src="images/logo.png" alt="" /></h1></a>
        </div>
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					<li><a href="../resources/templates/index.jsp" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div class="video-grid">
							<iframe src="finishvideo/1563203208850.mp4" allowfullscreen></iframe>
						</div>
					</div>
